...
/* package HaskellMnistMLP-0.1.0.0 */
#ifndef VERSION_HaskellMnistMLP
#define VERSION_HaskellMnistMLP "0.1.0.0"
#endif /* VERSION_HaskellMnistMLP */
#ifndef MIN_VERSION_HaskellMnistMLP
#define MIN_VERSION_HaskellMnistMLP(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "HaskellMnistMLP-0.1.0.0-inplace-HaskellMnistMLP"
